/* maps/static/maps/styles/google_places.js*/

// scriptfile used in google_route.html to autocomplete route points

// script to call google api to init autocomplete
...
// function to check if inputfield has changed
...
// check if form inputs are valid places with coordinates
...
function CalcRoute(){
  if ( validateForm() == true){
    ...
    var query = Object.keys(params)
      ...
      .join('&');
    url = '/maps/googlemap?' + query
    // reditect to map url with location params added to it
